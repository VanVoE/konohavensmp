...
import { FaClipboard, FaDiscord, FaBook } from 'react-icons/fa'
...
function Steps() {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-20 p-5 max-w-screen-lg mx-auto'>
        ...
        <h1 className='text-white text-3xl md:text-5xl montserrat text-center'>Very Important</h1>
        </motion.div>
        <motion.div initial="hiddenLeft" whileInView="showLeft" variants={variants} transition={{duration:1}} viewport={{ once: true, amount:.3}} className='flex flex-col items-center mt-10 gap-10'>
            
            <button className='mt-10'><a href="https://coda.io/@konohaven/konohaven-info-guide/rules-requirements-3" rel="noreferrer" target="_blank"> <FaBook className='text-7xl text-white animate-bounce'/></a></button>
        ...
        <button className='mt-10'><a href="https://discord.gg/zd9EuAkrZV" rel="noreferrer" target="_blank"> <FaDiscord className='text-8xl text-white animate-bounce'/></a></button>
        </motion.div>
        ...
        <h1 className='text-white text-3xl md:text-5xl montserrat text-center'>Serious Applications Only</h1>
         ...
         <div className='mt-10'>
          <p>
            ...
            feel free to ask in chat or open a staff ticket.
